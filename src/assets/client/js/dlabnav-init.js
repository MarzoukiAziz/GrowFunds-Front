...
if (bodyElement) {
	...
	bodyElement.setAttribute("data-nav-headerbg", "color_1");
	bodyElement.setAttribute("headerBg", "color_1");
	bodyElement.setAttribute("data-headerbg", "color_1");
	bodyElement.setAttribute("data-sibebarbg", "color_1");
	bodyElement.setAttribute("data-theme", "theme_2");
	...
	bodyElement.setAttribute("data-container", "full");
}